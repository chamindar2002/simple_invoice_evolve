<?php /* Smarty version 2.6.18, created on 2016-06-20 07:50:54
         compiled from ../templates/default/invoices/details.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlsafe', '../templates/default/invoices/details.tpl', 29, false),array('modifier', 'date_format', '../templates/default/invoices/details.tpl', 34, false),array('modifier', 'outhtml', '../templates/default/invoices/details.tpl', 92, false),array('modifier', 'siLocal_number_formatted', '../templates/default/invoices/details.tpl', 107, false),array('modifier', 'siLocal_number_clean', '../templates/default/invoices/details.tpl', 243, false),)), $this); ?>
<br />
...
<form name="frmpost" action="index.php?module=invoices&amp;view=save" method="post">
 ...
 <?php echo $this->_tpl_vars['LANG']['number_short']; ?>
</td><td> <?php echo ((is_array($_tmp=$this->_tpl_vars['invoice']['index_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
 </td>
	</tr>
	<tr>
	...
	<?php if ($this->_tpl_vars['invoice']['id'] == null): ?> 
        	<td><input type="text" size="10" class="date-picker" name="date" id="date1" value="<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
" /></td>
	<?php else: ?>
        	<td><input type="text" size="10" class="date-picker" name="date" id="date1" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoice']['calc_date'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" /></td>
	<?php endif; ?>
	</tr>
	<tr>
...
?>
				<option <?php if ($this->_tpl_vars['customer']['id'] == $this->_tpl_vars['invoice']['customer_id']): ?> selected <?php endif; ?> value="<?php echo ((is_array($_tmp=$this->_tpl_vars['customer']['id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
...
<?php if ($this->_tpl_vars['invoice']['type_id'] == 1): ?>
	        ...
	        <tr>
			<td colspan="6" ><textarea input type="text" class="editor" name="description0" rows="10" cols="70" wrap="nowrap"><?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItems']['0']['description'])) ? $this->_run_mod_handler('outhtml', true, $_tmp) : outhtml($_tmp)); ?>
</textarea></td>
        	</tr>
	 ...
	 <?php echo $this->_tpl_vars['customFields']['4']; ?>
			...
			<td>
			<input type="text" name="unit_price0" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItems']['0']['unit_price'])) ? $this->_run_mod_handler('siLocal_number_formatted', true, $_tmp) : siLocal::number_formatted($_tmp)); ?>
" size="10" />
			<input type="hidden" name="quantity0" value="1" />
			<input type="hidden" name="id0" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItems']['0']['id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" />
			<input type="hidden" name="products0" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItems']['0']['product_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" />
...
?>
									<option <?php if ($this->_tpl_vars['tax']['tax_id'] === $this->_tpl_vars['invoiceItems']['0']['tax'][$this->_tpl_vars['index']]): ?> selected <?php endif; ?> value="<?php echo ((is_array($_tmp=$this->_tpl_vars['tax']['tax_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
...
' 
								value='<?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItem']['quantity'])) ? $this->_run_mod_handler('siLocal_number_formatted', true, $_tmp) : siLocal::number_formatted($_tmp)); ?>
' 
								size="10"
							/>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['tax']['tax_description'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
						...
						<?php endfor; endif; ?>
						<td>
							<input id="unit_price<?php echo ((is_array($_tmp=$this->_tpl_vars['line'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" name="unit_price<?php echo ((is_array($_tmp=$this->_tpl_vars['line'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" size="7" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['invoiceItem']['unit_price'])) ? $this->_run_mod_handler('siLocal_number_clean', true, $_tmp) : siLocal::number_clean($_tmp)); ?>
" />
						</td>
			        </tr>
