<?php /* Smarty version 2.6.18, created on 2016-06-20 07:38:27
         compiled from ../templates/default/billers/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlsafe', '../templates/default/billers/add.tpl', 32, false),array('function', 'html_options', '../templates/default/billers/add.tpl', 159, false),)), $this); ?>
...
" size="25" id="name" class="validate[required]"></td>
	</tr>
	<tr> 
...
" size="25" /></td>
	...
	<tr>
		...
		<td><input type="text" name="paypal_business_name" value="<?php echo ((is_array($_tmp=$_POST['paypal_business_name'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" size="25" /></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['paypal_notify_url']; ?>
</td>
		<td><input type="text" name="paypal_notify_url" value="<?php echo ((is_array($_tmp=$_POST['paypal_notify_url'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" size="50" /></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['paypal_return_url']; ?>
</td>
		<td><input type="text" name="paypal_return_url" value="<?php echo ((is_array($_tmp=$_POST['paypal_return_url'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" size="50" /></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['eway_customer_id']; ?>
</td>
		<td><input type="text" name="eway_customer_id" value="<?php echo ((is_array($_tmp=$_POST['eway_customer_id'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
" size="50" /></td>
	</tr>
	<tr>
...
"
	...
	<tr>
		...
		<td><textarea input type="text" class="editor" name="footer" rows="4" cols="50"><?php echo ((is_array($_tmp=$_POST['footer'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
</textarea></td>
	</tr>
	<tr>
		<td class="details_screen"><?php echo $this->_tpl_vars['LANG']['notes']; ?>
</td>
		<td><textarea  input type="text" class="editor" name="notes" rows="8" cols="50"><?php echo ((is_array($_tmp=$_POST['notes'])) ? $this->_run_mod_handler('htmlsafe', true, $_tmp) : htmlsafe($_tmp)); ?>
</textarea></td>
	</tr>
	<tr>
